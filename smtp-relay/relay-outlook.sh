...
#
# Script para configuracao de relay smtp para o outlook no CentOS 7 / Red Hat 7 / Oracle Linux 7
#
...
echo "[smtp-mail.outlook.com]:587 $email:$senha" > /etc/postfix/sasl_passwd
#
# CONFIGURACAO DA PERMISSAO DO ARQUIVO
chmod 600 /etc/postfix/sasl_passwd
#
# CONFIGURACOES NO main.cf
echo "relayhost = [smtp-mail.outlook.com]:587" >> /etc/postfix/main.cf
